class Square:
    ...
    def get_description(self):
        ...
        """
        info_circumference = (
            "Square with side length {} cm has circumference {} cm.".format(
                self.side_length, round(self.circumference(), 3)
            )
        )
        info_area = "Square with side length {} cm has area {} cm2.".format(
            self.side_length, round(self.area(), 3)
        )
