...
class Circle:
    ...
    def get_description(self):
        ...
        """
        info_circumference = (
            "Circle with radius {} cm has circumference {:.3f} cm.".format(
                self.radius, round(self.circumference(), 3)
            )
        )
        info_area = "Circle with radius {} cm has area {:.3f} cm2.".format(
            self.radius, round(self.area(), 3)
        )
